...
public class Sumador extends javax.swing.JFrame {
    ...
    Model m_modelo;
    public Sumador(Model modelo) {
        initComponents();
        m_modelo = modelo;
    }
    void addSumar(ActionListener aS)
    {
        jButton1.addActionListener(aS);
    }
    
    void sumar()
    {
        jTextField3.setText(""+m_modelo.getSuma(Integer.parseInt(jTextField1.getText()),Integer.parseInt(jTextField2.getText())));
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(jButton1)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jTextField3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
                .addContainerGap())
        );
